...
export default function postItem({
  ...
  async function handleUpVote(e) {
    const { data, error } = await supabase
      .from('upvotes')
      .insert([{ auth_id: user.id, post_id: id }])
    setUser()
      ...
      >
        <HStack align='start' spacing='4'>
          ...
          <Stack>
            ...
            <Text fontSize='md' fontWeight='normal' as='i'>
              {description}
            </Text>
            ...
            <Text fontSize='sm'>
              ...
              from {authorCohort} on {formatDate(postCreated)} |{' '}
              <Link fontWeight='bold' textColor='orange.500' href='#comments'>
